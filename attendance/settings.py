...
SECRET_KEY = 'django-insecure-9^@%&obe*0&&r74zq%cq01+b5w(!o#ma8-aq#^16-+#r*%d1(q'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['attendance_app/static/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTHENICATION_BACKENDS='attendance_app.EmailBackEnd.EmailBackEnd'
